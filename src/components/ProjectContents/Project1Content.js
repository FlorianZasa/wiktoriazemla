            ...
            <div className="subcontainer">
                <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'center', alignItems: 'center', gap: '4rem' }}>
                    <div style={{minWidth: '300px', flex: 1}}>
                        ...
                        <br></br><br></br>
                        <b>Creating Engaging Introductions:</b>Content Development: My work ensured that these introductions were informative and suitable for a young audience, containing all necessary content to prepare users for the exercises and to facilitate effective learning.
                        <br></br><br></br>
